...
import hexagonNutritionItems from "../../assets/js/HomeMiddleCarouselsJs/hexagonNutritionItems.js";

const HexagonNutritionCarousel = () => {
  const data = hexagonNutritionItems;
  ...
  return (
    ...
    <Container fluid id={styles.limitedCarousel_Container}>
      <Row>
        <Col>
          <h1 className={styles.limitTitle}>Hexagon nutrition</h1>
...
export default HexagonNutritionCarousel;
